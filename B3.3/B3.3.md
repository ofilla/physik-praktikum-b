...
### $Q$-Wert
Der Energiedifferenz zwischen Ausgangs- und Endprodukt ist durch den $Q$-Wert gegeben, der die Massendifferenz zwischen Mutterkern $\isotope[A][Z]{X}$, Tochterkern $\isotope[A-4][Z-2]{Y}$ sowie Heliumkern  $\isotope[4][2]{He}$ darstellt.[^1] Diese wird durch die Masse-Energie-Relation $E=mc^2$ mittels der Lichtgeschwindigkeit $c$ in eine Energie umgerechnet.
...
Dennoch ist die Energie des $\alpha$-Teilchens nicht groß genug, um die Potentialbarriere zu überwinden. Deswegen muss es hindurch *tunneln*, was im Folgenden beschrieben wird.
