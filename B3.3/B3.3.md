...
## Abhängigkeit zwischen Reichweite und Druck
...
Für eine feste Energie $E_i \in \{0, E_0\}$ ist die Geschwindigkeit der Teilchen konstant. Dann folgt aus Gleichung $(\mathrm{dEtoP})$ eine Proportionalität zwischen dem $i$-ten Integranden und dem inversen Druck $p_i$.
