...
\begin{eqnarray}
	\bar{R} &=&
		...
		&=&
			...
			\right)^{-1}
			\mathrm dE \\
	\Rightarrow \bar R &\propto& \frac{1}{\bar p} \tag{R(1/p)}
\end{eqnarray}
$$
...
## Abschätzung der Anzahl von Stößen in Luft
...
## Reichweiten
Nun sollen die Reichweite der $\alpha$-Teilchen in Luft bestimmen. Dies kann durch den linearen Zusammenhang von mittlerer Reichweite $\bar R$ und dem inversen Druck $\frac{1}{p}$ erfolgen, der in Gleichung $(R(1/p))$ dargestellt ist.
