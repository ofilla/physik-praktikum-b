...
\begin{align}
	\begin{split}
		(\Delta A)^2 \eqspaced
		& \big((-z'_{12}z'_2 + u'z'_{12} - u'z'_2)\Delta z'_1\big)^2
			+\big((u'z'_{12}-z'_1z'_{12}-u'z'_1)\Delta z_2\big)^2 \\
		&+\big((u'z'_2-z'_1z'_2+u'z'_1)\Delta z'_{12}\big)^2
			+ \big((z'_{12}z'_2 + z'_{12}z'_1 -z'_1z'_2)\Delta u'\big)^2
	\end{split} \\
	(\Delta B)^2 \eqspaced&  (2z'_2 \Delta z'_1)^2 + (2z'_1 \Delta z'_2)^2 + (-2u' \Delta z'_{12})^2 + (-2z'_{12} \Delta u')^2 \\
	(\Delta C)^2 \eqspaced& (\Delta z'_1)^2 + (\Delta z'_2)^2 + (\Delta z'_{12})^2 + (\Delta u')^2
\end{align}
