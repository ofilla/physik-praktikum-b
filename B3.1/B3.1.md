...
$$
\begin{eqnarray}
	F(\chi^2_\mathrm{min}, f) &=& 0.975 \tag{eq:ChiMinFormula} \\
	F(\chi^2_\mathrm{max}, f) &=& 0.025 \tag{eq:ChiMaxFormula}
\end{eqnarray}
$$
...
\begin{eqnarray}
	...
	F(\chi^2_\mathrm{max}, f) &=& 0.05 \tag{eq:ChiMaxPearson} \\
\end{eqnarray}
$$
...
9. Mary L. McHugh, [The Chi-square test of independence](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3900058), Biochemia Medica, DOI [10.11613/BM.2013.018](https://doi.org/10.11613/BM.2013.018)
