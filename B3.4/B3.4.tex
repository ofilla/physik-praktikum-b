...
Für eine PET-Messung sind Compton-Effekt und Photoeffekt relevant. Die Energie der bei der Paarvernichtung erzeugten Gammaquanten ist zu niedrig, um Paarbildung zu verursachen, aber zu hoch für den Photoeffekt. Daher ist zunächst der Compton-Effekt relevant. Wenn die Energie der Strahlung dadurch genügend reduziert wurde, kann es zum Photoeffekt kommen.
...
Als erstes sollen die Signale von der verwendeten Elektronik einzeln am Oszilloskop betrachtet werden. Die Quelle wird für diesen Teil mittig zwischen den Detektoren platziert.
...
\begin{table}[h!]
	...
	\begin{tabular}{c|r|r||c|r|r}
		...
		$-0.5 \pm 0.5$ & 36 $\pm$ 6 & 0.60 $\pm$ 0.10 &
			$0.5 \pm 0.5$ & 36 $\pm$ 6 & 0.60 $\pm$ 0.10 \\
		$\pm 0.0 \pm 0.5$ & 22 $\pm$ 5 & 0.37 $\pm$ 0.08 &---&---$\quad\ \ $&---\hspace{8mm}
	\end{tabular}
