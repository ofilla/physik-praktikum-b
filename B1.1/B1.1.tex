...
\begin{eqnarray}
	E_J &=& \tilde{B} J (J + 1) \label{eq:Energie rotiertes Dipolmoment} \\
...
Die Übergangsfrequenzen $\nu_{J, J+1}$ und $\nu_{J, J-1}$ und die Richtung des R-- bzw. P--Zweigs lassen sich der Energie. Die die Gesamtenergie eines  quantenmechanischen harmonischen Oszillators ist die Summe der Energie aus der Oszillation $E_\mathrm{osz}$ und der des Dipolmomentes im Magnetfeld $E_\mathrm{mag}$ \eqref{eq:Energie rotiertes Dipolmoment}. Die Energie des Photons $E_J$ \eqref{eq:Energie Photon} muss dieser entsprechen.

\begin{eqnarray}
	E_J &=& E_\mathrm{osz} + E_\mathrm{mag} \\
	\Leftrightarrow\qquad h \nu_j &=& h \nu_0 \left(v + \frac{1}{2}\right) + \tilde{B} J (J + 1)
\end{eqnarray}
