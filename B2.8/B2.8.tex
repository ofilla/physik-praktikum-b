...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{LiF.pdf}
...
\begin{figure}[ht]
	\begin{minipage}[t]{.3\linewidth}
		\includegraphics[width=\textwidth]{Nadeleindruck.pdf}
		\caption{Eine Rosette nach Nadeleindruck \cite[S. 18]{Newey}}
		\label{abb:Rosette}
	\end{minipage}
	\begin{minipage}[t]{.3\linewidth}
		\includegraphics[width=\textwidth]{Rosette_Schema.pdf}
		\caption{Schematische Darstellung einer Rosette \cite[S. 21]{Newey}}
		\label{abb:Schema Rosette}
	\end{minipage}
	\begin{minipage}[t]{.3\linewidth}
		\includegraphics[width=\textwidth]{Gleitsysteme_Druck.pdf}
	...
	\begin{minipage}[t]{\linewidth}
		\centering
		\includegraphics[width=0.9\linewidth]{Gleitsysteme.pdf}
...
\begin{figure}[ht]
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Dichte1_not_tempered.pdf}
		\caption{Ätzgrübchendichte nicht-getemperte Probe, Aufnahme $1$}
		\label{abb:dichte_nt_1}
	\end{minipage}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Dichte2_not_tempered.pdf}
...
\begin{figure}[ht]
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Dichte1_tempered.pdf}
		\caption{Ätzgrübchendichte nicht-getemperte Probe, Aufnahme $1$}
		\label{abb:dichte_t_1}
	\end{minipage}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Dichte2_tempered.pdf}
		\caption{Ätzgrübchendichte nicht-getemperte Probe, Aufnahme $2$}
...
\begin{figure}[h]
	\begin{minipage}[t]{.31\linewidth}
		\includegraphics[width=\textwidth]{KWK1_tempered.pdf}
		\caption{Messung 1}
		\label{abb:KWK1}
	\end{minipage}
	\begin{minipage}[t]{.31\linewidth}
		\includegraphics[width=\textwidth]{KWK2_tempered.pdf}
		\caption{Messung 2}
		\label{abb:KWK2}
	\end{minipage}
	\begin{minipage}[t]{.31\linewidth}
		\includegraphics[width=\textwidth]{KWK3_tempered.pdf}
		\caption{Messung 3}
		\label{abb:KWK3}
	\end{minipage}
...
\begin{figure}[ht]
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Rosetten_uebersicht.pdf}
		\caption{Nadeldruckrosetten}
		\label{abb:Rosetten all}
	\end{minipage}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Rosetten_1.pdf}
	...
	\vspace{8pt}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Rosetten_2.pdf}
		\caption{Rosette $2$: Ecke}
		\label{abb:Rosetten 2}
	\end{minipage}
	\begin{minipage}[t]{.5\linewidth}
	\includegraphics[width=\textwidth]{Rosetten_3.pdf}
...
\begin{figure}[ht]
	\begin{minipage}[t]{\linewidth}
		\centering
		\includegraphics[width=0.7\textwidth]{Druck_uebersicht.pdf}
		\caption{Abb. 12}
		\label{abb:Druck all}
	\end{minipage}
	...
	\vspace{8pt}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Druck1.pdf}
		\caption{Versetzungswanderung $1$}
		\label{abb:Druck 1}
	\end{minipage}
	\begin{minipage}[t]{.5\linewidth}
		\includegraphics[width=\textwidth]{Druck2.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{Querschnittsflaeche_tempered.pdf}
