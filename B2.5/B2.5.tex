...
Die Ergebnisse der einzelnen Korrugationen sind in den Tabellen \ref{table:Korrugation 1} und \ref{table:Korrugation 2} dargestellt. Daraus ergeben sich folgende mittlere Korrugationen $\bar{K}$.
...
\begin{table}[h!]
	...
	\begin{align*}
		...
		& 0.18 && 0.12 && 0.03 \\
	\end{align*}
	\caption{erste Korrugationsmessung von HOPG}
	\label{table:Korrugation 1}
\end{table}
...
\begin{table}[h!]
	...
	\begin{align*}
	    ...
	    &\text{Korrugation} &K\ [\mathrm{nm}] &&
	        & 0.08 && 0.14 && 0.12 \\
	\end{align*}
	\caption{zweite Korrugationsmessung von HOPG}
	\label{table:Korrugation 2}
\end{table}
