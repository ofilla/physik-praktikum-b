...
Nicht alle physikalischen Größen können kontinuierliche Werte annehmen. In der Quantenmechanik sind nur bestimmte diskrete Werte erlaubt. Demnach ist auch die Energie in Atomen gequantelt. Durch die Quantenhypothese ist die minimale Größe $E$ der Energiepakete bekannt, die übertragen werden. Diese wird durch das reduzierte Planck'sche Wirkungsquantum $\hbar$ und die Kreisfrequenz $\omega$ beschrieben
...
\noindent
%Dabei finden der Bohr'sche Radius $a$ und die reduzierte Masse $\mu$ Verwendung.
Die Energiedifferenz $E_{21}$ zwischen zwei Energiezuständen entspricht der Energie des Photons, das bei dem Übergang zwischen den Zuständen erzeugt oder vernichtet wird.
